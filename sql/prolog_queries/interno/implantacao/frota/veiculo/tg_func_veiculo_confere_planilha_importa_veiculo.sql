...
-- 2020-05-19 -> Adiciona o atributo identificador_frota ao insert/update (thaisksf - PL-2712).
-- 2020-05-26 -> Adiciona verificações de cod_empresa e cod_unidade (thaisksf - PL-2711).
-- 2020-11-20 -> Adiona colunas e verificações para nova funcionalidades de acoplamento (thaisksf - PL-3288).
