-- Sobre:
--
-- Function utilizada para listar os cargos utilizados na unidade. Um cargo utilizado é um cargo que possui algum
-- colaborador associado, não tendo relação com a quantidade de permissões liberadas que possui.
--
-- Histórico:
