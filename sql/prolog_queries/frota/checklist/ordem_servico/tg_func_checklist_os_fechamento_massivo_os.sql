...
--
-- Importante: O COD_PERGUNTA e COD_ALTERNATIVA são os códigos do primeiro apontamento presentes na tabela COSI.Não é o
-- código de contexto.
--
...
-- 2020-04-27 -> Corrige colunas utilizadas (COD_PERGUNTA e COD_ALTERNATIVA) (luiz_fp).
-- 2020-05-15 -> Altera para security definer (luiz_fp).
