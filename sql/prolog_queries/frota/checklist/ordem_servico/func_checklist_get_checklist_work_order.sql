create or replace function func_checklist_get_checklist_work_order(f_branches_id bigint[],
    ...
    returns table
            (
                ...
                branch_id              bigint,
                checklist_id           bigint,
                opened_at_utc          timestamp with time zone,
                opened_at_with_tz      timestamp without time zone,
