...
select vap.nome_unidade_alocado                               as nome_unidade_alocado,
       ...
       to_char(vap.data_hora_primeira_afericao, 'DD/MM/YYYY') as data_primeira_afericao,
       to_char(vap.data_hora_ultima_afericao, 'DD/MM/YYYY')   as data_ultima_afericao,
       ...
       vap.km_acumulado                                       as km_acumulado,
