-- Sobre:
--
-- Essa function é responsável por buscar todas as aferições realizadas a partir do último código da aferição
-- realizada.
-- O último código da aferição realizada é utilizado como um Offset de busca, todas as aferições a
-- partir deste código serão retornadas por essa function. Não é realizada validação para verificar se este código
-- pertence a empresa correspondente ao token, ou seja: pode ser um número qualquer.
--
-- Histórico:
-- 2020-05-07 -> Function criada (natanrotta - PLI-144).
