-- Sobre:
-- Lógica aplicada:
-- A function é responsável por validar posições em um diagrama. Caso alguma posição não exista no diagrama informado,
-- é retornado uma mensagem que contém todas as posições inválidas.
--
-- Histórico:
-- 2020-03-31 -> Function criada (natanrotta - PLI-52).
-- 2020-04-06 -> Corrige utilização do array_length (diogenesvanzella - PLI-114).
-- 2020-04-24 -> Modifica variável recebida (natanrotta - PLI-132).
