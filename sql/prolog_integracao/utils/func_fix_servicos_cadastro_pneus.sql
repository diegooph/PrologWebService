-- Sobre:
--
-- Function auxiliar utilizada para consertar vida de pneus. Bug encontrado por conta da integração.
--
-- Histórico:
-- 2020-07-27 -> Arquivo base criado (diogenesvanzella - PLI-189).
