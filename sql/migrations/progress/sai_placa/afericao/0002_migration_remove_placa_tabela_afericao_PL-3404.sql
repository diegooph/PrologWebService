alter table afericao_data drop constraint if exists fk_afericao_cod_veiculo_placa;

alter table afericao_data
    add constraint fk_afericao_cod_veiculo foreign key (cod_veiculo)
references veiculo_data (codigo);

alter table afericao_data drop constraint if exists check_estado_placa_km;

alter table afericao_data add constraint check_estado_veiculo_km
...
alter table afericao_data drop column if exists placa_veiculo;