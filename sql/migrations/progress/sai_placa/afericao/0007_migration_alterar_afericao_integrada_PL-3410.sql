alter table integracao.afericao_integrada add column if not exists cod_veiculo bigint;

drop function integracao.func_pneu_afericao_insert_afericao_integrada(
f_cod_unidade_prolog bigint,
