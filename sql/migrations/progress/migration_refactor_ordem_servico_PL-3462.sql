create
    ...
    returns table
            (
                ...
                status_os                                        text,
                data_hora_fechamento_utc                         timestamp without time zone,
                data_hora_fechamento_tz_aplicado                 timestamp with time zone,
                codigo_colaborador_abertura                      bigint,
                cpf_colaborador_abertura                         bigint,
...
select cos.codigo_prolog                                                as codigo_os_prolog,
       ...
       cos.data_hora_fechamento at time zone tz_unidade(cd.cod_unidade) as data_hora_fechamento_utc,
       cos.data_hora_fechamento                                         as data_hora_fechamento_tz_aplicado,
       cd.codigo                                                        as codigo_colaborador_abertura,
       cd.cpf                                                           as cpf_colaborador_abertura,
