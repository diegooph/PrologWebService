...
comment on column unidade_valores_rm.rm_motorista_as_cx_sem_jornada_fator1
    is 'Valor da caixa a ser pago para motoristas que não bateram jornada em mapas de AS fator 1';

comment on column unidade_valores_rm.rm_motorista_as_cx_sem_jornada_fator2
    is 'Valor da caixa a ser pago para motoristas que não bateram jornada em mapas de AS fator 2';

comment on column unidade_valores_rm.rm_ajudante_as_cx_sem_jornada_fator1
    is 'Valor da caixa a ser pago para ajudantes que não bateram jornada em mapas de AS fator 1';

comment on column unidade_valores_rm.rm_ajudante_as_cx_sem_jornada_fator2
    is 'Valor da caixa a ser pago para ajudantes que não bateram jornada em mapas de AS fator 2';
...
comment on column unidade_valores_rm.as_paga_por_cx
    is 'Parametrização a ser usada em caso de unidade pagar mapas de AS com base no número de caixas entregues';

comment on column unidade_valores_rm.diferenca_eld_soma_total
    is 'Parametrização que permite que a unidade escolha se o ELD soma no total ou não';
