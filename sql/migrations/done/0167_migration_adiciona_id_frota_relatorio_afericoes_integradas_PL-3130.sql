...
drop function integracao.func_pneu_afericao_busca_afericoes_realizadas_by_codigo(text, bigint);
...
-- 2020-09-30 -> Adiciona id_frota (thaisksf - PL-3130).
drop function integracao.func_pneu_afericao_busca_afericoes_realizadas_by_data_hora(text, timestamp without time zone);
create or replace function
