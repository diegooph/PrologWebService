...
-- Cria unique para podermos usar na function de associar treinamento.
alter table quiz_modelo_treinamento
    add constraint unico_treinamento_por_modelo unique (cod_modelo_quiz);
