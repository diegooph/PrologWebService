-- #####################################################################################################################
-- #####################################################################################################################
-- ############################### Adicionar código auxiliar no tipo de veículo ########################################
-- #####################################################################################################################
-- #####################################################################################################################
-- PL-2560
-- Cria a coluna de código auxiliar na tabela veiculo_tipo.
ALTER TABLE VEICULO_TIPO
    ADD COD_AUXILIAR TEXT;

-- Dropa a funcion antiga de atualização de tipo de veículo
DROP FUNCTION FUNC_VEICULO_UPDATE_TIPO_VEICULO(BIGINT, TEXT, BIGINT);

-- Recria a function com a possibilidade de inserir o código auxiliar
