-- PLI-165
-- Criamos uma function para retornar os valores
...
select codigo                                   as cod_unidade_prolog,
       regexp_split_to_table(cod_auxiliar, ',') as cod_auxiliar
from public.unidade
where codigo = any (f_cod_unidades)
  and cod_auxiliar is not null;
$$;

-- Inserimos o cod_auxiliar das unidades no retorno.
...
-- PLI-166
-- Possibilitamos a configuração de mais de um cod_auxiliar para um cod_unidade Prolog.
...
-- Recebemos o codAuxiliarUnidade na function
