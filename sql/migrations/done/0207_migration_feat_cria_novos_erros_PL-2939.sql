...
values ('SA1A2', 'SERVER_SIDE_ERROR', 'Erro especificando que o problema ocorreu do lado do servidor.'),
       ('SA1A3', 'CLIENT_SIDE_ERROR', 'Erro especificando que o problema ocorreu do lado do cliente.');

------------------------------------------------------------------------------------------------------------------------
create schema log;

-- Tables
alter table log_json
    set schema log;
alter table integracao.old_log_requisicao
    set schema log;
alter table integracao.log_request_response
    set schema log;
-- Functions
drop function if exists integracao.func_geral_salva_log_integracao(f_log_type text,
...
drop function if exists integracao.func_busca_logs_pneu_integracao(f_cod_empresa bigint,
    f_data_inicio_filtro date,
    f_cod_cliente_pneu text,
    f_apenas_logs_erro boolean);
