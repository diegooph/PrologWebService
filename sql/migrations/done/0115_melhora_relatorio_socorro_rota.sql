-- Adiciona tempo entre abertura e finalização do socorro em rota.

DROP FUNCTION PUBLIC.FUNC_SOCORRO_ROTA_RELATORIO_DADOS_GERAIS(F_COD_UNIDADES BIGINT[],
    F_DATA_INICIAL DATE,
    F_DATA_FINAL DATE,
...
CREATE OR REPLACE FUNCTION PUBLIC.FUNC_SOCORRO_ROTA_RELATORIO_DADOS_GERAIS(F_COD_UNIDADES BIGINT[],
    ...
    RETURNS TABLE
            (
                ...
                "TEMPO ENTRE ABERTURA/FINALIZAÇÃO HH:MM:SS"                   TEXT,
...
BEGIN
    RETURN QUERY
        SELECT U.NOME :: TEXT                                          AS NOME_UNIDADE,
               ...
               COALESCE(FUNC_CONVERTE_INTERVAL_HHMMSS(
                                SRF.DATA_HORA_FINALIZACAO - SRAB.DATA_HORA_ABERTURA),
                        '-')                                           AS TEMPO_ABERTURA_FINALIZACAO,
               COALESCE(FUNC_CONVERTE_INTERVAL_HHMMSS(
