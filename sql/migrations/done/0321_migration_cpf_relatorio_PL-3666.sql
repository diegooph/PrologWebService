drop function func_relatorio_extrato_relatos(f_data_inicial date,
                                             f_data_final date,
                                             f_cod_unidade bigint,
                                             f_equipe text);

create or replace function func_relatorio_extrato_relatos(f_data_inicial date,
                                                          f_data_final date,
                                                          f_cod_unidade bigint,
                                                          f_equipe text)
    returns TABLE
            (
                ...
                "DESCRIÇÃO"                       text,
                "COD_PDV"                         integer,
                "RELATADO POR - CPF"              text,
                "RELATADO POR - NOME"             text,
                "EQUIPE"                          text,
                "DATA CLASSIFICAÇÃO"              text,
                "TEMPO PARA CLASSIFICAÇÃO (DIAS)" integer,
                "CLASSIFICADO POR - CPF"          text,
                "CLASSIFICADO POR - NOME"         text,
                "DATA FECHAMENTO"                 text,
                "TEMPO PARA FECHAMENTO (DIAS)"    integer,
                "FECHADO POR - CPF"               text,
                "FECHADO POR - NOME"              text,
                "OBS FECHAMENTO"                  text,
                "LATITUDE"                        text,
                "LONGITUDE"                       text,
                "LINK MAPS"                       text,
