...
create index idx_afericao_unidade_data
    on afericao_data (cod_unidade asc, data_hora desc);

-- Testes realizados utilizando o SELECT interno da func em um BD clone de prod com os seguintes parâmetros:
-- f_cod_unidades: array [215, 9, 10, 11]
-- f_data_inicial: '2020-01-01'
-- f_data_final: '2020-11-01'

-- Antes:
-- Planning Time: 6.049 ms
-- Execution Time: 3600.448 ms

-- Depois:
-- Planning Time: 7.294 ms
-- Execution Time: 964.426 ms
