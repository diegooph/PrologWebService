create or replace function migration_checklist.func_migration_1_cria_estrutura_versionamento_modelo()
    returns void
    language plpgsql
as
$$
begin
    ...
    begin
        ...
        where codigo = f_cod_modelo and cod_versao_atual is null;
        ...
        where cod_checklist_modelo = f_cod_modelo and cod_versao_checklist_modelo is null;
