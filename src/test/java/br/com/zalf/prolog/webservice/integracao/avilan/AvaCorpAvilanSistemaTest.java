package br.com.zalf.prolog.webservice.integracao.avilan;
...
import static br.com.zalf.prolog.webservice.integracao.avilan.AvaCorpAvilanConstants.DEFAULT_TIMEOUT_MILLIS;
import static br.com.zalf.prolog.webservice.integracao.avilan.AvaCorpAvilanConstants.PROLOG_TOKEN;
...
public class AvaCorpAvilanSistemaTest {
    ...
    public void testInsertAfericao() throws Throwable {
        sistema.insertAfericao(0L, new AfericaoPlaca());
    }
