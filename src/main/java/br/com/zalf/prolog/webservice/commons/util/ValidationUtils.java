...
public final class ValidationUtils {
    ...
    public static boolean isValidCpf(@NotNull String cpf) {
        if (!BuildConfig.DEBUG) {
            ...
            Integer digitoVerificador1 = calcularDigito(cpf.substring(0, 9), PESOS_CPF_DV1);
            Integer digitoVerificador2 = calcularDigito(cpf.substring(0, 9) + digitoVerificador1, PESOS_CPF_DV2);

            String generatedCpf = cpf.substring(0, 9) + digitoVerificador1.toString() + digitoVerificador2.toString();
     ...
     */
    private static int calcularDigito(String str, int[] pesosCpf) {
