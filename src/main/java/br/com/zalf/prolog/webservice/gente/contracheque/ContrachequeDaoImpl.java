...
//                    calcularemos agora o valor das recargas e da produtividade
                    ...
                    recargas = produtividadeDao.getTotalRecargas(itensProdutividade);
                    produtividade = produtividadeDao.getTotalItens(itensProdutividade) - recargas;

//                    a partir daqui temos todos os valores para realizar o calculo do premio
                    double premio;
                    if(restricoes.recargaPartePremio) {
                        premio = getPremio(conn, codUnidade, itens, bonus, recargas, produtividade);
                        ...
                        if(recargas > 0){
                            ...
                            itemRecargas.setValor(recargas);
