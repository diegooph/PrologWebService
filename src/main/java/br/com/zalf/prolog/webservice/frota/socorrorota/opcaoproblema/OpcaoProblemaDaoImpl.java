...
public final class OpcaoProblemaDaoImpl extends DatabaseConnection implements OpcaoProblemaDao {
    ...
    public List<UnidadeAberturaSocorro> getUnidadesDisponiveisAberturaSocorroByCodColaborador(
        ...
        try {
            ...
            while (rSet.next()) {
                unidades.add(OpcaoProblemaConverter.createUnidadeAberturaSocorro(rSet));
            }
            return unidades;
        } finally {
            close(conn, stmt, rSet);
    ...
    public List<VeiculoAberturaSocorro> getVeiculosDisponiveisAberturaSocorroByUnidade(@NotNull final Long codUnidade)
        ...
        try {
            ...
            while (rSet.next()) {
                veiculos.add(OpcaoProblemaConverter.createVeiculoAberturaSocorro(rSet));
            }
            return veiculos;
        } finally {
            close(conn, stmt, rSet);
    ...
    public List<SocorroRotaListagem> getListagemSocorroRota(@NotNull final List<Long> codUnidades,
        ...
        try {
            ...
            while (rSet.next()) {
                socorrosRota.add(OpcaoProblemaConverter.createSocorroRotaListagem(rSet));
            }
            return socorrosRota;
        } finally {
            close(conn, stmt, rSet);
        ...
        try {
            ...
            if (rSet.next()) {
                final SocorroRotaAberturaVisualizacao socorroRotaAberturaVisualizacao =
                        OpcaoProblemaConverter.createSocorroRotaAberturaVisualizacao(rSet);
                ...
                if (rSet.getObject("DATA_HORA_ATENDIMENTO", LocalDateTime.class) != null) {
                    socorroRotaAtendimentoVisualizacao =
                            OpcaoProblemaConverter.createSocorroRotaAtendimentoVisualizacao(rSet);
                }
                ...
                if (rSet.getObject("DATA_HORA_INVALIDACAO", LocalDateTime.class) != null) {
                    socorroRotaInvalidacaoVisualizacao =
                            OpcaoProblemaConverter.createSocorroRotaInvalidacaoVisualizacao(rSet);
                }
                ...
                if (rSet.getObject("DATA_HORA_FINALIZACAO", LocalDateTime.class) != null) {
                    socorroRotaFinalizacaoVisualizacao =
                            OpcaoProblemaConverter.createSocorroRotaFinalizacaoVisualizacao(rSet);
                }
