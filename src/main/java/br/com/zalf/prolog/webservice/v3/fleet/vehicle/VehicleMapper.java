...
public class VehicleMapper {
    ...
    public VehicleEntity toEntity(@NotNull final VehicleCreateDto dto,
        ...
        return VehicleEntity.builder()
                ...
                .withPlate(dto.getPlacaVeiculo())
                .withFleetId(dto.getIdentificadorFrota())
                .withVehicleKm(dto.getKmAtualVeiculo())
                .withHasHubodometer(dto.getPossuiHubodometro())
    ...
    private VehicleDto createVehicleDto(@NotNull final VehicleEntity vehicleEntity) {
        ...
        return new VehicleDto(
                ...
                branchEntity.getGroupEntity().getId(),
                branchEntity.getGroupEntity().getName(),
