 ...
 */
@Deprecated
public class DEPRECATED_ORDEM_SERVICO_SERVICE_2 {
    private static final String TAG = DEPRECATED_ORDEM_SERVICO_SERVICE_2.class.getSimpleName();
    @NotNull
    private final DEPRECATED_ORDEM_SERVICO_DAO_2 dao = new DEPRECATED_ORDEM_SERVICO_DAO_IMPL_2();
